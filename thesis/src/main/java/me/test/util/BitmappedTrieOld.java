...
public class BitmappedTrieOld<E> {
	...
	public BitmappedTrieOld(FastArrayList<E> list) {
		this();
	...
	public BitmappedTrieOld(List<E> list) {
		this();
...
//		level = 0;
	...
	private BitmappedTrieOld(final Object[] oldData, 
...
//			System.arraycopy(oldTail, 0, tail, 0, oldTail.length);
	...
	public BitmappedTrieOld<E> addElement(E e) {
		...
		if (stale.getAndSet(true)) {
			...
			return new BitmappedTrieOld<E>(data, newTail, tailIndex, level, index, e);
		}
		else {
			return new BitmappedTrieOld<E>(data, tail, tailIndex, level, index, e);
		}
	...
	public static void main(String[] args) {
		...
		BitmappedTrieOld<Integer> trie7 = new BitmappedTrieOld<Integer>();
		...
		BitmappedTrieOld<Integer> trie5 = new BitmappedTrieOld<Integer>(Arrays.asList(0));
		...
		BitmappedTrieOld<Integer> trie3 = new BitmappedTrieOld<Integer>(fastList);
		...
		BitmappedTrieOld<Integer> trie4 = new BitmappedTrieOld<Integer>();
		...
		BitmappedTrieOld<Integer> trie2 = new BitmappedTrieOld<Integer>();
		...
		BitmappedTrieOld<Integer> trie1 = new BitmappedTrieOld<Integer>(list);
